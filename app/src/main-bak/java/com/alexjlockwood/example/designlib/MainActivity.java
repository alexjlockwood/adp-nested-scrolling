...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    Glide.with(this).asDrawable()
        ...
        .apply(RequestOptions.centerCropTransform(this))
        .transition(DrawableTransitionOptions.withCrossFade())
        .into((ImageView) findViewById(R.id.background_image));

    final RecyclerView rv = (RecyclerView) findViewById(R.id.card_recyclerview);
    ...
    rv.addItemDecoration(new DividerItemDecoration(this) {
      ...
      protected boolean shouldDrawDividerAboveItem(int position) {
        // Don't draw a divider above the first item in the list.
        return position > 0;
      }
    });
